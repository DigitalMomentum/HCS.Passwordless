# HCS.Umbraco.Passwordless.Core — CLAUDE.md
...
The csproj grants internal visibility to `HCS.Umbraco.Passwordless.MagicLink`, `.Otp`, `.WebAuthn`, and `.Tests` so add-ons can use internal helpers without making them public API.
