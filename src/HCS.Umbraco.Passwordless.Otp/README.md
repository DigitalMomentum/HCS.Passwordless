# HCS.Umbraco.Passwordless.Otp

OTP (One-Time Password) add-on for `HCS.Umbraco.Passwordless`. Delivers a short numeric code by email that the member enters to sign in.
...
builder.CreateUmbracoBuilder()
    ...
    .AddPasswordlessOtp()      // chain after AddPasswordlessMembers
    .Build();
```
